...
public class UIManager : MonoBehaviour
{
    ...
    [Header("Input Actions & Controls")] public InputAction pauseAction;
    ...
    /// <summary>
    ///     Standard Unity function called once when the script instance first exists in runtime of the game. Called before
    ///     Start.
    /// </summary>
    private void Awake()
    {
