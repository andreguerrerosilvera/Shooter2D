...
public class LoadSceneCommand : DeveloperConsoleCommand
{
    ...
    {
        var failureMessage = "Error loading scene: | " + sceneIndex + " |" + "\n\n";
    ...
    {
        var helpMessage = "|LoadScene| \n\nTo use |LoadScene| order your command as: |LoadScene| |SceneIndex| \n";
        helpMessage +=
            "Without the vertical bars and where SceneIndex is the index of the scene in the build settings you wish to load." +
